...
export function buildAnalysisPrompt(
  ...
  return [
    ...
    "- Whether the source proves that the user selected, owned, used, or contracted it, versus merely mentioning it in boilerplate, a catalog, an option list, general terms, or an annex",
    ...
    "- Do not recommend standalone pages for products, plans, programs, services, or organizations that appear only in boilerplate, catalogs, generic terms, option lists, comparison tables, or annexes. Mention them only in the source summary unless the source contains user-specific evidence of selection, ownership, use, payment, correspondence, or a signed/individualized agreement.",
...
export function buildGenerationPrompt(
  ...
  return [
    ...
    "- Separate personalized evidence from generic boilerplate. A product or service appearing only in general terms, an annex, a catalog, an option list, or a comparison table is NOT evidence that the user owns, uses, selected, or contracted it.",
    "- Do not create or update standalone entity/concept pages for boilerplate-only items. Keep them de-emphasized in the source summary and explicitly label them as unselected/general context when needed.",
...
function buildChunkAnalysisSystemPrompt(
  ...
  return [
    ...
    "- Distinguish user-specific facts from items mentioned only in boilerplate, catalogs, generic terms, option lists, or annexes; boilerplate-only items are not page candidates",
...
async function executeIngestWritesImpl(
  ...
  const writePrompt = [
    ...
    "Do not create standalone pages for products, services, plans, or organizations mentioned only in boilerplate, catalogs, generic terms, option lists, or annexes unless user-specific evidence proves selection, ownership, use, payment, correspondence, or an individualized agreement.",
